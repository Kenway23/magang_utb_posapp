...
@section('title', 'Pengiriman Stok - PROShop')

@section('header-title', 'Pengiriman Stok')
@section('header-subtitle', 'Catat pengiriman stok barang keluar')

@section('content')
    <div class="space-y-6">
        {{-- Form Pengiriman Stok --}}
                ...
                <form class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="Tujuan pengiriman"
                                class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500">
                        </div>
                ...
                <table class="min-w-full divide-y divide-slate-200">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        <tr class="hover:bg-slate-50 transition">
                            ...
                            <td class="px-6 py-3 text-sm font-medium text-slate-700">Indomie Goreng</td>
                            <td class="px-6 py-3 text-sm text-red-600 font-semibold">-46</td>
                            <td class="px-6 py-3 text-sm text-slate-600">Toko Budi Jaya</td>
                            <td class="px-6 py-3"><span
                                    class="px-2 py-1 text-xs rounded-full bg-green-100 text-green-700"><i
                                        class="fas fa-check-circle mr-1"></i>Terkirim</span></td>
                        ...
                        <tr class="hover:bg-slate-50 transition">
                            ...
                            <td class="px-6 py-3 text-sm text-red-600 font-semibold">-20</td>
                            <td class="px-6 py-3 text-sm text-slate-600">Toko Sejahtera</td>
                            <td class="px-6 py-3"><span
                                    class="px-2 py-1 text-xs rounded-full bg-yellow-100 text-yellow-700"><i
                                        class="fas fa-clock mr-1"></i>Proses</span></td>
                            <td class="px-6 py-3"><button class="text-indigo-600 hover:text-indigo-800"><i
                                        class="fas fa-print"></i></button></td>
                        </tr>
                    </tbody>
