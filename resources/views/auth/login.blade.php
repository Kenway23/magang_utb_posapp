...
<body class="font-sans antialiased relative overflow-x-hidden">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <input type="password" id="password" name="password" placeholder="Masukkan password"
                                    class="input-password" autocomplete="off">
    ...
    <div id="modalUsernamePasswordEmpty" class="fixed inset-0 z-50 hidden items-center justify-center modal-backdrop"
        style="display: none;">
        <div class="bg-white rounded-2xl max-w-md w-full mx-4 animate-modalFadeIn shadow-2xl">
            <div class="relative">
                <div class="absolute -top-6 left-1/2 transform -translate-x-1/2">
        ...
        <div class="bg-white rounded-2xl max-w-md w-full mx-4 animate-modalFadeIn shadow-2xl">
            <div class="relative">
                ...
                <div class="pt-10 pb-6 px-6">
                    ...
                    <p class="text-gray-600 text-center mb-4">Apakah Anda yakin ingin login dengan data berikut?</p>
        ...
        <div class="bg-white rounded-2xl max-w-md w-full mx-4 animate-modalFadeIn shadow-2xl">
            <div class="relative">
                ...
                <div class="pt-10 pb-6 px-6 text-center">
                    ...
                    <p class="text-gray-600" id="errorMessage">Username atau password yang Anda masukkan salah!</p>
    ...
    <script>
        ...
        function proceedLogin() {
            ...
            // Gunakan fetch untuk koneksi ke backend Laravel
            fetch('{{ url('/login') }}', {
                    method: 'POST',
                    headers: {
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        if (successUsernameSpan) {
                            successUsernameSpan.innerHTML = '<i class="fas fa-user-circle mr-1"></i> ' + username;
                        }
                        ...
                        // Login gagal - tampilkan modal error
                        const errorMessageSpan = document.getElementById('errorMessage');
                        if (errorMessageSpan) {
                            errorMessageSpan.innerHTML = data.message ||
                                'Username atau password yang Anda masukkan salah!';
                        }
                        openModal('modalError');

                        // Animasi shake pada form
                        if (usernameInput) usernameInput.classList.add('animate-shake');
                        if (passwordField) passwordField.classList.add('animate-shake');
                        setTimeout(() => {
                            if (usernameInput) usernameInput.classList.remove('animate-shake');
                            if (passwordField) passwordField.classList.remove('animate-shake');
                        }, 500);
                    }
                })
                .catch(error => {
                    ...
                    const errorMessageSpan = document.getElementById('errorMessage');
                    if (errorMessageSpan) {
                        errorMessageSpan.innerHTML = 'Terjadi kesalahan koneksi. Silakan coba lagi.';
                    }
                    openModal('modalError');
